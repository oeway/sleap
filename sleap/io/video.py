...
class SingleImageVideo:
    ...
    flipud: Optional[bool] = attr.ib(default=False)
    channel_index: Optional[int] = attr.ib(default=None)
    ...
    def _load_idx(self, idx):
        ...
        # additional options for flipping images generated by Kaibu/ImJoy
        if self.flipud:
            img = np.flipud(img)
...
class Video:
    ...
    def from_image_filenames(
        ...
        **kwargs,
        ...
        backend = SingleImageVideo(filenames=filenames, **kwargs)
        if height:
